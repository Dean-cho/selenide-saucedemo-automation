...
import com.saucedemo.testcases.CheckHomeProductAddToCart;
...
public class HomeProductAddToCartTest {
    @BeforeAll
    ...
    @Test
    void testHomeProductAddToCart() {
        SF.get(CheckHomeProductAddToCart.class).proceed().validate();
    }
}
