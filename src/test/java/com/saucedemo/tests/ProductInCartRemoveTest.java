...
import com.saucedemo.testcases.CheckProductInCartRemove;
...
public class ProductInCartRemoveTest {
    ...
    @Test
    void testProductInCartRemove(){
        SF.get(CheckProductInCartRemove.class).proceed().validate();
    }
